...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-9Q5Juii3.mjs");
...
var manifest = {
	"0972d93ce719b68d87eb20b64083762d958ae8935306208d9729f45381e39a00": {
		functionName: "getCatalog_createServerFn_handler",
		importer: () => import("./catalog-BMREDhq2.mjs")
	},
	"bb7e7e2450555d24df3a04bab1583d6f54ed73c3a89806649a7ebbe96e61ca4b": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-hN-A8a3D.mjs").then((n) => n.t),
