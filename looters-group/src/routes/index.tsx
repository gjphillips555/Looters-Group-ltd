    ...
    <div className="min-h-dvh bg-ink text-cream">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-20">
          ...
          <h1 className="mt-4 max-w-2xl font-display text-4xl font-extrabold tracking-tight sm:text-6xl">
            Looters Group Ltd
          </h1>
          ...
          <div className="mt-10 grid gap-3 sm:grid-cols-3">
            {BRANCHES.map((b) => (
              ...
              >
                ...
                />
                <span className="mt-2 text-xs font-semibold uppercase tracking-[0.14em] text-muted">
                  {b.name}
                </span>
              </Link>
            ))}
          ...
          <div className="mt-8 flex flex-col items-start gap-5 rounded-3xl bg-ink p-5 text-cream shadow-border sm:flex-row sm:items-center">
            ...
            <div className="max-w-sm">
              ...
              <p className="mt-2 text-sm leading-relaxed text-cream/70">
                Privacy first. So easy even your toddler could use it. Looters
                Software — available here soon.
              </p>
              <Link
                to="/software"
                className="mt-4 inline-flex min-h-10 items-center text-sm font-semibold text-software-hot hover:underline"
              >
                Looters Software
              </Link>
            </div>
