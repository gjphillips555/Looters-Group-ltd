      ...
      <main>
        <section className="border-b border-line bg-computas text-cream">
          <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 md:py-16">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-relaxed text-cream/80">
              Quality refurbished laptops and desktops, tested for work, study or home. All our
              systems are sold Refurbished unless stated that they are sold As-Is. All refurbished
              systems have fresh CMOS batteries, are freshly cleaned out, and usually have a fresh
              install of a suitable operating system for that device.
            </p>
        ...
        <section className="border-y border-line bg-cream/50 py-12">
          <div className="mx-auto max-w-3xl px-4 sm:px-6">
            <h2 className="text-center font-display text-2xl font-extrabold">The Shoshana Sale</h2>
            <p className="mt-2 text-center text-sm text-muted">
              10% off — watch the promo, then shop live listings.
            </p>
            <div className="mt-6">
              <PromoVideo />
            </div>
        ...
        <section className="mx-auto max-w-6xl px-4 pb-16 sm:px-6">
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              {
                t: "Location",
                d: STORE.address.join(", ") + ". Afterpay accepted when enabled at checkout.",
              },
            ].map((c) => (
